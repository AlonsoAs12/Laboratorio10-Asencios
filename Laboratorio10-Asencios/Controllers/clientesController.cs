...
using Laboratorio10_Asencios.Models;

namespace Laboratorio10_Asencios.Controllers
{
    public class clientesController : Controller
    {
        ...
        // POST: clientes/Update/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update([Bind(Include = "idCliente,NombreCompañia,NombreContacto,CargoContacto,Direccion,Ciudad,Region,CodPostal,Pais,Telefono,Fax")] clientes clientes)
        {
            if (ModelState.IsValid)
            {
                db.Entry(clientes).State = EntityState.Modified;
